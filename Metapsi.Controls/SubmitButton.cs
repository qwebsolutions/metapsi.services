...
namespace Metapsi.Controls
{
    ...
    {
        public static Var<HyperNode> NavigateButton(this LayoutBuilder b, Var<Metapsi.Controls.NavigateButton.Props> props)
        {
            return b.Call(Metapsi.Controls.NavigateButton.Render, props);
        }

        public static Var<HyperNode> NavigateButton(this LayoutBuilder b, Action<Modifier<NavigateButton.Props>> updateDefaults)
        {
            return b.FromDefault(Metapsi.Controls.NavigateButton.Render, updateDefaults);
        }

        public static Var<HyperNode> SubmitButton<TPayload>(this LayoutBuilder b, Var<Metapsi.Controls.SubmitButton.Props<TPayload>> props)
        {
            return b.Call(Metapsi.Controls.SubmitButton.Render, props);
        }
