...
namespace Metapsi.Controls
{
    ...
    public static class DataGridExtensions
    {
        public static DataGridDefinition<TRow> DefaultDataGrid<TRow>()
        {
            ...
            dataGrid.Table = Metapsi.HtmlControls.Control.DefaultTable<TRow>();
            dataGrid.Toolbar = Metapsi.Controls.Control.DefaultToolbar();
    ...
    public static partial class Controls
    {
        ...
        {
            return Metapsi.Controls.DataGrid.Render<TRow>(b, buildToolbar, buildDataTable, buildActions);
