...
namespace Metapsi.Controls
{
    ...
    public static partial class Controls
    {
        ...
        {
            var props = b.NewObj<Metapsi.Controls.Input.Props<TState>>(b =>
                {
            ...
            return b.Call(Metapsi.Controls.Input.Render, props);
        }
            ...
            System.Action<Modifier<Input.Props<object>>> optional = null)
        {
            ...
            var props = b.NewObj<Metapsi.Controls.Input.Props<object>>(b =>
            {
