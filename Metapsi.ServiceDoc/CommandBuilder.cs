...
public static partial class ServiceDoc
{
    public class CommandBuilder
    {
        ...
        //public void AppendCommand(string statement, params string[] parameterName)
        //{
        //    stringBuilder.Append(statement);
        //    stringBuilder.AppendLine(";");
    ...
    //public static void AddInsertDocumentStatement<T>(this CommandBuilder commandBuilder)
    //{
    //    var parameterName = commandBuilder.NextParameterName();
    //    commandBuilder.AppendCommand(CommandBuilder.GetInsertStatement(typeof(T), parameterName), parameterName);
    //}

    //public static async Task<DbCommand<T>> GetInsertDocumentCommand<T>(this DbConnection dbConnection)
    //{
    //    dbConnection.BuildCommand(cb =>
    //    {

    //    });
    //    var commandBuilder = new CommandBuilder(dbConnection);
    //    commandBuilder.AddInsertDocumentStatement<T>();
    //    var command = commandBuilder.GetCommand();
    //    await command.PrepareAsync();
    //    return new DbCommand<T>(command);
    //}

    //public static async Task<DbCommand<T>> PrepareInsertDocumentCommand<T>(this DbConnection dbConnection)
    //{
    //    var commandBuilder = new CommandBuilder(dbConnection);
    //    commandBuilder.AddInsertDocumentStatement<T>();
    //    var command = commandBuilder.GetCommand();
    ...
    //public static void DeleteDocuments<TDocument, TValue>(this CommandBuilder commandBuilder, string byIndexProperty)
    //{
    //    var parameterName = commandBuilder.NextParameterName();
    //    commandBuilder.AppendCommand(CommandBuilder.GetDeleteDocumentsStatement(typeof(TDocument), byIndexProperty, parameterName), parameterName);
    //}

    //public static void DeleteDocuments<TDocument, TValue>(this CommandBuilder commandBuilder, System.Linq.Expressions.Expression<Func<TDocument, TValue>> byIndexProperty)
    //{
    //    commandBuilder.DeleteDocuments<TDocument, TValue>(byIndexProperty.PropertyName());
    //}

    //public static void DeleteReturnDocuments<TDocument,TValue>(this CommandBuilder commandBuilder, string byIndexProperty)
    //{
    //    var parameterName = commandBuilder.NextParameterName();
    //    commandBuilder.AppendCommand(CommandBuilder.GetDeleteReturnDocumentsStatement(typeof(TDocument), byIndexProperty, parameterName), parameterName);
    //}

    //public static void DeleteReturnDocuments<TDocument, TValue>(this CommandBuilder commandBuilder, System.Linq.Expressions.Expression<Func<TDocument, TValue>> byIndexProperty)
    //{
    //    commandBuilder.DeleteReturnDocuments<TDocument, TValue>(byIndexProperty.PropertyName());
    //}

    //public static void SaveDocument<T>(this CommandBuilder commandBuilder)
    //{
    //    var parameterName = commandBuilder.NextParameterName();
    //    commandBuilder.AppendCommand(CommandBuilder.GetSaveDocumentStatement(typeof(T), parameterName), parameterName);
    //}
    ...
    //public static void GetDocuments<T, TValue>(this CommandBuilder commandBuilder, string byIndexProperty)
    //{
    //    var parameterName = commandBuilder.NextParameterName();
    //    commandBuilder.AppendCommand(CommandBuilder.GetSelectDocumentsStatement(typeof(T), byIndexProperty, parameterName), parameterName);
    //}

    //public static void GetDocuments<T, TValue>(this CommandBuilder commandBuilder, System.Linq.Expressions.Expression<Func<T, TValue>> byIndexProperty)
    //{
    //    commandBuilder.GetDocuments<T, TValue>(byIndexProperty.PropertyName());
    //}
    ...
    //public static DbCommand BuildCommand(this DbConnection dbConnection, Action<CommandBuilder> action, DbTransaction dbTransaction = null)
    //{
